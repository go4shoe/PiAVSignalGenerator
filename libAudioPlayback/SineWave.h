...
//     $Author: Markus $
//
//       $File: //depot/pi/libAudioPlayback/SineWave.h $
//
//   $Revision: #4 $
//
//       $Date: 2017/09/25 $
...
extern const short g_aSineWaveValues[];
extern const int   g_nSineWaveEntries;

inline short GetSin(int x)
{
   return g_aSineWaveValues[ x & (g_nSineWaveEntries-1)];
}

inline int GetSinResolution()
{
   return g_nSineWaveEntries;
}
